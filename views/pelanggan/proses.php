...
<?php
    ...
    if(!empty(getGet("aksi") == "update")) {
        ...
        $data[] =  htmlspecialchars($_POST["telepon_pelanggan"]);
        $data[] =  htmlspecialchars($_POST["email_pelanggan"]);
        $data[] =  htmlspecialchars($_POST["created_at"]);
        $data[] =  htmlspecialchars($_POST["deleted_at"]);

        $data[] = $id;
        $sql = "UPDATE pelanggan SET kode_pelanggan = ?, nama_pelanggan = ?, alamat_pelanggan = ?, telepon_pelanggan = ?, email_pelanggan = ?, created_at = ?, deleted_at = ?  WHERE id = ? ";
