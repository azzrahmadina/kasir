            ...
            <div class="card-body">
                <form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $kode;?>" required name="id_barang" id="id_barang" placeholder="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" value="<?= date('Y-m-d');?>" class="form-control" required name="tgl_input" id="tgl_input" placeholder="">
                    </div>
