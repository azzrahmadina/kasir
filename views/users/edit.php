            ...
            <div class="card-body">
                <form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $edit->telepon;?>" name="telepon" id="telepon" placeholder=""/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" accept="image/*" name="avatar" id="avatar" placeholder=""/>
                    </div>
                
                    <div class="form-group">
                        <label for="">Username</label>
                        <input type="text" class="form-control" readonly required value="<?= $edit->user;?>" name="user" id="user" placeholder=""/>
                    </div>
