            ...
            <div class="col-sm-12">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive-1 pt-3">
                                    ...
                                    <tr>
                                        ...
                                        <form method="post" action="proses.php?aksi=editkeranjang">  
                                            <td>
                                                <input type="number"  
                                                    class="form-control" 
                                                    name="beli" style="width:150px !important;"
                                                    value="<?=$r->beli;?>">
                                            </td> 
                                            <td>
                                                <input type="number"  
                                                    class="form-control" 
                                                    name="jual" style="width:150px !important;"
                                                    value="<?=$r->jual;?>">
                                            </td> 
                                            <td>
                                                <input type="number" style="width:80px !important;" 
                                                    class="form-control" 
                                                    name="qty"
                                                    value="<?=$r->jumlah;?>">
                                            </td>      
                                            <td>Rp<?= number_format($r->beli * $r->jumlah);?>,-</td> 
                                            <td>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" 
                        ...
                        <div class="table-responsive mt-4">
                            <table class="table table-striped table-sm table-bordered w-100" id="table-artikel-query-limit">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>ID Barang</th>
