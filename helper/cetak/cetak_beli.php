...
<head>
    ...
    <link rel="icon" href="http://localhost/dev/pos_ci_oprek/favicon.ico" type="image/x-icon">
            ...
            <div id="laporan">
                <div class="mt-4">
                    ...
                    <p class="text-center"><?= $toko->alamat_toko;?> <br><?= $toko->tlp;?></p>
                        ...
                        <span class="float-left">Akun Gudang : <?= $edit->name;?></span>
                        <br>
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>Rp<?= number_format($edit->beli);?>,</th>       
                                    </tr>
                               </tfoot>
                            </table>
