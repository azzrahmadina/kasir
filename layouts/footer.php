    ...
    <footer class="main-footer">
        <strong>Copyright &copy;<?=date('Y');?> <a href="#">Sistem Kasir</a>.</strong>
            All rights reserved.
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><span class="fas fa-power-off mr-2 text-danger"></span> Perhatian!!</h5>
...
<!-- ./wrapper -->
    ...
    <script>
        $(function () {
            ...
            $('#example5').DataTable({"responsive": true,"paging":false,"ordering":false,"info":false});
        });
    </script>
    <script type="application/javascript">
        //angka 500 dibawah ini artinya pesan akan muncul dalam 0,5 detik setelah document ready
		$(document).ready(function(){setTimeout(function(){$(".alert-danger").slideUp('slow');}, 5000);})
		//angka 3000 dibawah ini artinya pesan akan hilang dalam 3 detik setelah muncul
		setTimeout(function(){$(".alert-danger").slideUp('slow');}, 5000);
		$(document).ready(function(){setTimeout(function(){$(".alert-success").slideUp('slow');}, 5000);})
		setTimeout(function(){$(".alert-success").slideUp('slow');}, 5000);
		$(document).ready(function(){setTimeout(function(){$(".alert-info").slideUp('slow');}, 5000);})
		setTimeout(function(){$(".alert-info").slideUp('slow');}, 5000);
		$(document).ready(function(){setTimeout(function(){$(".alert-error").slideUp('slow');}, 5000);})
