...
<body class="hold-transition login-page">
    ...
    <script type="application/javascript">
		...
		$(document).ready(function(){setTimeout(function(){$(".alert-danger").slideUp('slow');}, 3000);})
		//angka 3000 dibawah ini artinya pesan akan hilang dalam 3 detik setelah muncul
		setTimeout(function(){$(".alert-danger").slideUp('slow');}, 3000);
		$(document).ready(function(){setTimeout(function(){$(".alert-success").slideUp('slow');}, 3000);})
		setTimeout(function(){$(".alert-success").slideUp('slow');}, 3000);
		$(document).ready(function(){setTimeout(function(){$(".alert-info").slideUp('slow');}, 3000);})
		setTimeout(function(){$(".alert-info").slideUp('slow');}, 3000);
		$(document).ready(function(){setTimeout(function(){$(".alert-error").slideUp('slow');}, 3000);})
		setTimeout(function(){$(".alert-warning").slideUp('slow');}, 3000);
    </script>
</body>
</html>
