...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <button type="button" class="btn btn-danger btn-flat"><a href="index.php?stok=yes" class="text-white"><i class="fa fa-times mr-1"></i> Stok Limit</a></button>
            <button type="button" class="btn btn-success btn-flat"><a href="index.php" class="text-white"><i class="fas fa-sync mr-1"></i> Refresh</a></button>
        </div>
        <br><br>
        <div class="card">
            <!-- Card header -->
