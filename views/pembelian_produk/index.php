    ...
    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                ...
                                <?php if(!empty($_GET['cari'])){?>
                                    <a href="<?= $baseURL;?>helper/cetak/excel_beli_produk.php?excel=yes&cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" class="btn btn-info"><i class="fas fa-file-excel"></i>
                                    Excel</a>
                                    <a href="<?= $baseURL;?>helper/cetak/excel_beli_produk.php?cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" target="_blank" class="btn btn-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="btn-group mt-4 pt-2" role="group" aria-label="First group">
                                ...
                                <a href="<?= $baseURL;?>helper/cetak/excel_beli_produk.php?excel=yes&hari=cek&tgla=<?= $_GET['tgla'];?>&tglb=<?= $_GET['tglb'];?>"
                                    target="_blank" class="btn btn-info btn-flat">
                                    <i class="fas fa-file-excel"></i>
                                    Excel</a>
                                <a href="<?= $baseURL;?>helper/cetak/excel_beli_produk.php?hari=cek&tgla=<?= $_GET['tgla'];?>&tglb=<?= $_GET['tglb'];?>"
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <?php if(!empty($_GET['cari'])){ ?>
                        Data Laporan Pembelian Barang <?= $bulan_tes[$_POST['bln']];?> <?= $_POST['thn'];?>
        ...
        tabel = $('#table-artikel-query').DataTable({
            ...
            "ajax":{
                <?php if(isset($_POST['thn'])){?>
                    "url": "<?= $baseURL.'/helper/data.php?aksi=nota-beli-produk&thn='.$_POST['thn'].'&bln='.$_POST['bln'];?>", // URL file untuk proses select datanya
                <?php }elseif(isset($_GET['hari'])){?>
                    "url": "<?= $baseURL.'/helper/data.php?aksi=nota-beli-produk&hari=yes&tgla='.getGet('tgla').'&tglb='.getGet('tglb');?>", // URL file untuk proses select datanya
                <?php }else{?>
