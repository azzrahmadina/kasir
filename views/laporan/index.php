    ...
    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="btn-group mr-2 mb-2 btn-block" role="group" aria-label="First group">
                                ...
                                <?php if(!empty($_GET['cari'])){?>
                                    <a href="<?= $baseURL;?>helper/cetak/excel.php?excel=yes&cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" class="btn btn-info"><i class="fas fa-file-excel"></i>
                                    Excel</a>
                                    <a href="<?= $baseURL;?>helper/cetak/excel.php?cari=yes&bln=<?=$_POST['bln'];?>&thn=<?=$_POST['thn'];?>" target="_blank" class="btn btn-primary">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-block" role="group" aria-label="First group">
                                    ...
                                    <?php if(!empty($_GET['hari'])){?>
                                        <a href="<?= $baseURL;?>helper/cetak/excel.php?excel=yes&hari=cek&tgla=<?= $_GET['tgla'];?>&tglb=<?= $_GET['tglb'];?>" target="_blank" class="btn btn-info btn-flat">
                                        <i class="fas fa-file-excel"></i>
                                        Excel</a>
                                        <a href="<?= $baseURL;?>helper/cetak/excel.php?hari=cek&tgla=<?= $_GET['tgla'];?>&tglb=<?= $_GET['tglb'];?>" target="_blank" class="btn btn-primary btn-flat">
                                        <i class="fas fa-print"></i>
                                        Print</a>
                                    <?php }else{?>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <?php if(!empty($_GET['cari'])){ ?>
                        Data Laporan Nota Penjualan <?= $bulan_tes[$_POST['bln']];?> <?= $_POST['thn'];?>
        ...
        tabel = $('#table-artikel-query').DataTable({
            ...
            "ajax": {
                <?php if(isset($_POST['thn'])){?>
                    "url": "<?= $baseURL.'/helper/data.php?aksi=nota-jual&thn='.$_POST['thn'].'&bln='.$_POST['bln'];?>", // URL file untuk proses select datanya
                <?php }elseif(isset($_GET['tgla'])){?>
                    "url": "<?= $baseURL.'/helper/data.php?aksi=nota-jual&hari=yes&tgla='.getGet('tgla').'&tglb='.getGet('tglb');?>", // URL file untuk proses select datanya
                <?php }else{?>
            ...
            "columns": [
                ...
                { "data": "id",
                    "render": 
                    function( data, type, row, meta ) {
                        return `<a href="<?= $baseURL."helper/cetak/cetak.php?no=";?>${row.no_trx}" target="_blank"
