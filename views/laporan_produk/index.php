...
<script>
    ...
    $(document).ready(function() {
        tabel = $('#table-artikel-query').DataTable({
            ...
            "ajax": {
                <?php if (isset($_POST['thn'])) { ?> "url": "<?= $baseURL . '/helper/data.php?aksi=nota-jual-produk&thn=' . $_POST['thn'] . '&bln=' . $_POST['bln']; ?>", // URL file untuk proses select datanya
                <?php } elseif (isset($_GET['tgla'])) { ?> "url": "<?= $baseURL . '/helper/data.php?aksi=nota-jual-produk&hari=yes&tgla=' . getGet('tgla') . '&tglb=' . getGet('tglb'); ?>", // URL file untuk proses select datanya
