<?php
    ...
    if(empty($edit)){ redirect($baseURL.'index.php'); }
?>
<!-- Page content -->
<div class="row">
            ...
            <div class="card-body">
                <form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $edit->id_barang;?>" name="id_barang" id="id_barang" placeholder=""/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" required name="id_kategori" id="id_kategori">
                            ...
                            ?>
                                <option 
                                    <?php if($edit->id_kategori == $r->id){ echo 'selected';}?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $edit->nama_barang;?>" class="form-control" name="nama_barang" id="nama_barang" placeholder="">
                    </div>
                
                    <div class="form-group">
                        <label for="">Merk</label>
                        <input type="text" class="form-control" value="<?= $edit->merk;?>" name="merk" id="merk" placeholder=""/>
                    </div>
                
                    <div class="form-group">
                        <label for="">Harga beli</label>
                        <input type="text" id="rupiah1" class="form-control" value="<?= $edit->harga_beli;?>" name="harga_beli" placeholder=""/>
                    </div>
                
                    <div class="form-group">
                        <label for="">Harga jual</label>
                        <input type="text" id="rupiah2" class="form-control" value="<?= $edit->harga_jual;?>" name="harga_jual" id="harga_jual" placeholder=""/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" required name="satuan_barang" id="satuan_barang">
                            ...
                            ?>
                                <option 
                                    <?php if($edit->satuan_barang == $r->satuan){ echo 'selected';}?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="<?= $edit->stok;?>" class="form-control" name="stok" id="stok" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Gambar <small class="text-danger">* opsional</small></label>
                        <input type="file" class="form-control" accept="image/*" name="gambar" id="gambar" placeholder="">
                        <br>
