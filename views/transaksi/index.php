                    ...
                    <div class="card-body pb-0">
                        <div class="form-group">
                            <input type="text" autofocus
                                name="cari_barang" id="cari_barang" 
                                class="form-control" placeholder="Masukan Kode / Nama Barang [ENTER]">
                        </div>
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="float-right">
                            ...
                            <button type="button" 
                                class="btn btn-primary btn-md mt-1 mb-2" 
                                data-toggle="modal" data-target="#modelId">
                                <i class="fa fa-search mr-1"></i> Daftar Barang
                            </button>
                            <button type="button" 
                                class="btn btn-danger btn-md mt-1 mb-2" 
                                data-toggle="modal" data-target="#modelIdReset">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive-1 pt-4">
                                    ...
                                    <tr>
                                        ...
                                        <form method="post" action="proses.php?aksi=editkeranjang">  
                                            <td>
                                                <input type="number" 
                                                    class="form-control" 
                                                    name="qty" style="width:80px !important;"
                                                    value="<?=$r->jumlah;?>">
                                            </td> 
                                            <td>
                                                <input type="number" 
                                                    class="form-control" 
                                                    name="diskon" style="width:150px !important;"
                                                    value="<?=$r->diskon;?>">
                                            </td>           
                                            <td>Rp<?= number_format(($r->jual * $r->jumlah) - $r->diskon);?>,-</td>  
                                            <td>
                                                <input type="hidden" value="<?=$r->id;?>"
                                                    class="form-control" 
                                                    name="id" id="id">
                                                <input type="hidden" value="<?=$r->id_barang;?>"
                                                    class="form-control" 
                                                    name="id_barang" id="id_barang">
                                                <button type="submit"
                                                    class="btn btn-success btn-sm mb-2" title="Edit Keranjang">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            <h5 class="text-right pt-1">Pelanggan <small class="text-danger">* Opsional</small></h5>
                                        </div>  
                                        ...
                                        <div class="col-sm-2 mb-3">
                                            <div class="form-group">
                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-md btn-block" data-toggle="modal" data-target="#modelIdPelanggan">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input type="text" id="rupiah1" autocomplete="off"
                                                class="form-control"  placeholder="Masukan Jumlah Uang"
                                                name="bayar" required 
                                                value="">
                                        </div>  
                                        <div class="col-sm-6 mb-3">
...
<?php
    ...
    $kodep = 'PL00'.$cekidp;
?>
<div class="modal fade" id="modelIdPelanggan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            ...
            <form action="proses.php?aksi=pelanggan" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required value="<?= $kodep;?>" readonly name="kode_pelanggan" id="kode_pelanggan" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Nama</label>
                        <input type="text" class="form-control" required name="nama_pelanggan" id="nama_pelanggan" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Telepon</label>
                        <input type="number" class="form-control" required name="telepon_pelanggan" id="telepon_pelanggan" placeholder="">
                    </div>

                    <div class="form-group">
                        <label for="">E-mail</label>
                        <input type="email" class="form-control" required name="email_pelanggan" id="email_pelanggan" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Alamat</label>
                        <textarea class="form-control" required name="alamat_pelanggan" id="alamat_pelanggan" placeholder=""></textarea>
                    </div>
                </div>
...
$(document).ready(function(){
	$("#cari_barang").change(function(){
		$.ajax({
            ...
            beforeSend: function(){
                $("#hasil_cari").hide();
                $("#tunggu").html('<p style="color:green"><blink><i class="fa fa-sync fa-spin mr-1"></i> tunggu sebentar</blink></p>');
            },
