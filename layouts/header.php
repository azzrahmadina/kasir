...
if (!empty(getSegments($baseURL, '1'))) {
    if (getSegments($baseURL, '1') . '/' . getSegments($baseURL, '2') == 'barang') {
        $sidebar = "sidebar-collapse";
    } else if (getSegments($baseURL, '1') . '/' . getSegments($baseURL, '2') == 'transaksi') {
        $sidebar = "sidebar-collapse";
    } else if (getSegments($baseURL, '1') . '/' . getSegments($baseURL, '2') == 'transaksi_beli') {
        $sidebar = "sidebar-collapse";
    } else {
        $sidebar = "";
    }
...
<body <?php if (in_array(getSegments($baseURL, '1'), ['', 'index.php'])) { ?>onload="jam()" <?php } ?> class="hold-transition sidebar-mini layout-fixed <?= $sidebar; ?>">
    <div class="wrapper">
        <!-- Preloader -->
